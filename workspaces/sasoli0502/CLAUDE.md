...
8. **【バグ修正・スピード化】査定のスキル化** → `/assessment`（データ整理部分完了、連絡・結果連絡は今後追加）
9. **【新規】価格調整のスキル化**
10. **【バグ修正・スピード化】財務管理系スキル化**（残り確認のみ）
11. **【完了】消費税還付金の徹底調査**（約56万円還付見込み）
14. **【完了】Kintoneの不具合や修理の内容を全て適切なものに変更**
15. **【新規】ジャンク品の買取価格を全て確認し、変更**
16. **【新規】朝の金額KPI入力のスピード化** → `/morning-kpi`
17. **【新規】夜の金額KPI入力のスピード化** → `/evening-kpi`
18. **【新規】資金繰り表入力のスピード化** → `/cashflow-update`
19. **【新規】タスク設定のスピード化** → `/task-setup`
20. **【新規】BMコンディションチェックのスピード化** → `/bm-condition-check`
21. **【新規】価格調整のスピード化** → `/price-adjustment`
