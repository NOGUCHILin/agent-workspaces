...
oneoff_services = [
    ...
    'タイムズカー',
    'DCS・外神田1丁目店',
    '【引落日：2025年11月10日】2025年9月26日/ＡＭＡＺＯＮ．ＣＯ．ＪＰ/'
]
...
card_service_totals = defaultdict(lambda: defaultdict(int))
...
# マークダウン形式で出力
print("# 2025年9月 クレジットカード経費明細（サブスクリプションのみ）\n")
print("> **除外対象**: 仕入、備品購入、単発の飲食・交通費、立替経費など\n")
